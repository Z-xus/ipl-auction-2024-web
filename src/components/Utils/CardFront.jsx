...
const CardFront = ({ playerData, isSelected, onSelect }) => {
  ...
  return (
    <div style={{userSelect: "none"}} className={` card card-front w-32 h-44 p-1.5 rounded-xl border-fancy-blue relative overflow-hidden ${isSelected?"shadow-lg":""}`} onClick={handleClick}>
